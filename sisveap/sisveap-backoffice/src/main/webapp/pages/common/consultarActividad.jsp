...
<script type='text/javascript'>
    ...
    function initConsultarActividad() {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "<%=request.getContextPath()%>" + action + '?method=initConsultarActividad&codigoEstrategia='+getRequestParameter('codigoEstrategia')
